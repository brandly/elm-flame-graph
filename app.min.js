...
;var _user$project$Main$Model=F2(function(a,b){return{frames:a,selected:b}});var _user$project$Main$StackFrame=F3(function(a,b,c){return{ctor:"StackFrame",_0:a,_1:b,_2:c}});var _user$project$Main$ClearSelected={ctor:"ClearSelected"};var _user$project$Main$SelectFrames=function(a){return{ctor:"SelectFrames",_0:a}};var _user$project$Main$view=function(model){return A2(_elm_lang$html$Html$div,{ctor:"[]"},{ctor:"::",_0:function(){var _p8=model.selected;if(_p8.ctor==="Just"){return A2(_elm_lang$html$Html$button,{ctor:"::",_0:_elm_lang$html$Html_Events$onClick(_user$project$Main$ClearSelected),_1:{ctor:"[]"}},{ctor:"::",_0:_elm_lang$html$Html$text("remove zoom"),_1:{ctor:"[]"}})}else{return _elm_lang$html$Html$text("")}}(),_1:{ctor:"::",_0:function(){var _p9={ctor:"_Tuple2",_0:model.selected,_1:model.frames};_v7_2:do{if(_p9.ctor==="_Tuple2"){if(_p9._0.ctor==="Just"){return A2(_user$project$Main$viewFlameGraph,F2(function(_p10,newSelected){return _user$project$Main$SelectFrames(newSelected)}),_p9._0._0)}else{if(_p9._1.ctor==="Just"){return A2(_user$project$Main$viewFlameGraph,F2(function(_p11,newSelected){return _user$project$Main$SelectFrames(newSelected)}),_p9._1._0)}else{break _v7_2}}}else{break _v7_2}}while(false);return _elm_lang$html$Html$text("Loading...")}(),_1:{ctor:"[]"}}})};var _user$project$Main$PreStackFrame=F2(function(a,b){return{ctor:"PreStackFrame",_0:a,_1:b}});var _user$project$Main$preParse=function(input){return A2(_elm_lang$core$List$map,function(line){var _p12=_user$project$Main$parseLine(line);if(_p12.ctor==="Ok"){return A2(_user$project$Main$PreStackFrame,_p12._0._0,_p12._0._1)}else{return A2(_user$project$Main$PreStackFrame,{ctor:"[]"},0)}},A2(_elm_lang$core$String$split,"\n",input))};var _user$project$Main$nest=function(frames){var namedLists=A2(_user$project$Main$groupBy,function(f){var _p13=f;var _p14=_elm_lang$core$List$head(_p13._0);if(_p14.ctor==="Just"){return _p14._0}else{return""}},frames);return A2(_elm_lang$core$List$map,function(_p15){var _p16=_p15;var _p22=_p16._1;var children=A2(_elm_lang$core$List$filter,function(pre){var _p17=pre;return _elm_lang$core$Native_Utils.cmp(_elm_lang$core$List$length(_p17._0),0)>0},A2(_elm_lang$core$List$map,function(pre){var _p18=pre;var _p20=_p18._1;var _p19=_elm_lang$core$List$tail(_p18._0);if(_p19.ctor==="Just"){return A2(_user$project$Main$PreStackFrame,_p19._0,_p20)}else{return A2(_user$project$Main$PreStackFrame,{ctor:"[]"},_p20)}},_p22));var count=_elm_lang$core$List$sum(A2(_elm_lang$core$List$map,function(pre){var _p21=pre;return _p21._1},_p22));return A3(_user$project$Main$StackFrame,_p16._0,count,_user$project$Main$nest(children))},namedLists)};var _user$project$Main$parse=function(_p23){return _user$project$Main$nest(_user$project$Main$preParse(_p23))};var _user$project$Main$initialModel={frames:_elm_lang$core$Maybe$Just(_user$project$Main$parse(_user$project$Main$example)),selected:_elm_lang$core$Maybe$Nothing};var _user$project$Main$main=_elm_lang$html$Html$program({init:{ctor:"_Tuple2",_0:_user$project$Main$initialModel,_1:_elm_lang$core$Platform_Cmd$none},update:_user$project$Main$update,view:_user$project$Main$view,subscriptions:_user$project$Main$subscriptions})();var Elm={};Elm["Main"]=Elm["Main"]||{};if(typeof _user$project$Main$main!=="undefined"){_user$project$Main$main(Elm["Main"],"Main",undefined)}if(typeof define==="function"&&define["amd"]){define([],function(){return Elm});return}if(typeof module==="object"){module["exports"]=Elm;return}var globalElm=this["Elm"];if(typeof globalElm==="undefined"){this["Elm"]=Elm;return}for(var publicModule in Elm){if(publicModule in globalElm){throw new Error("There are two Elm modules called `"+publicModule+"` on this page! Rename one of them.")}globalElm[publicModule]=Elm[publicModule]}}).call(this);